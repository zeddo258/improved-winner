...
class ChatbotApp:
    ...
    def listen_and_process(self):
        if ( self.counter == 0 ):
            first_prompt = f"""你是<speaker>,我是<listener>. 現在<speaker>是(心理師). <speaker>傾聽<listener>, 以心理師的專業角色, 治療<listener>的心理症狀, 提供專業的對話. <listener>所提到的情緒, 健康, 人際關係, 家人相處現況, 以心理師的專業角色給予心理及物理上的協助. 若所提及的問題與心理治療無相關, 請持續保持心理師角色. 請以500字內容回應, 並排除過度積積極及過度樂觀用語."""
